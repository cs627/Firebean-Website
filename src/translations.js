...
(function () {
  ...
  const FALLBACK_DATA = [
    ...
    ["Insights", "SubLabel", "", "PR Market Decoded", "公關市場解碼", "PR市場の解読"],
    ["Insights", "Title", "Line1", "PR Market", "公關市場解碼", "PR市場"],
    ["Insights", "Title", "Line2", "Decoded", "大膽創想，深度連結。", "大胆な発想、深い繋がり。"],
    ["Insights", "Subtitle", "", "Peek behind the scenes of Hong Kong's lifestyle PR campaigns. Data, creativity, and the core motivations driving today's most compelling public relations stories.", "窺探顛覆生活風格市場的幕後故事。為您全面解析熱門公關企劃背後的數據、創意與核心動機。", "香港のライフスタイルPRキャンペーンの舞台裏を覗く。データ、創造性、そして今日の最も魅力的な広報ストーリーを支える原動力。"],
