...
(function () {
  ...
  const FALLBACK_DATA = [
    ...
    ["Roving","Hero","Subtitle","11 projects. 9 years. 6 government bureaus. 1.5M+ people engaged.","11個項目。9年經驗。6個政府部門。150萬+參與人次。","11プロジェクト。9年の実績。6つの政府機関。150万人以上が参加。"],
    ...
    ["Roving","Methodology","Step1Body","Concept development rooted in policy objectives and audience insights. Every exhibition starts with understanding who needs to be engaged and why.","以政策目標和受眾洞察為基礎的概念開發。每個展覽都始於理解誰需要被觸及，以及為何需要。","政策目標とオーディエンスインサイトに基づくコンセプト開発。各展示は、誰に、なぜ届けるべきかの理解から始まります。"],
    ["Roving","Methodology","Step2Title","Build & Brand","搭建與品牌","構築とブランディング"],
    ["Roving","Methodology","Step2Body","Modular, transportable exhibition design. Visual identity, interactive elements, and durable materials engineered for repeated assembly across multiple venues.","模組化、可運輸的展覽設計。視覺識別、互動元素及耐用物料，專為跨場地重複搭建而設計。","モジュール式で運搬可能な展示デザイン。ビジュアルアイデンティティ、インタラクティブ要素、複数会場での繰り返し組立に対応する耐久性のある素材。"],
    ["Roving","Methodology","Step3Title","Tour & Operate","巡迴與營運","巡回と運営"],
    ["Roving","Methodology","Step3Body","Full logistics management — transport, installation, on-site staffing, and real-time operational support across every venue on the tour schedule.","全方位物流管理 — 運輸、安裝、現場人手及即時營運支援，涵蓋巡迴日程上每個場地。","完全な物流管理 — 輸送、設置、現場スタッフ、リアルタイムの運営サポートを、ツアースケジュール上の全会場で提供。"],
    ["Roving","Methodology","Step4Title","Engage & Measure","互動與量度","エンゲージメントと測定"],
    ["Roving","Methodology","Step4Body","Interactive experiences that drive participation. Real-time engagement tracking, feedback collection, and post-tour analytics reporting for government stakeholders.","推動參與的互動體驗。即時參與追蹤、意見收集及巡迴後數據分析報告，滿足政府持份者需求。","参加を促進するインタラクティブな体験。リアルタイムのエンゲージメント追跡、フィードバック収集、政府ステークホルダー向けのツアー後分析レポート。"],
